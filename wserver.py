...
<body>
  <!--© Designed and coded by @bipuldey19-Telegram-->
    <header>
      ...
      <div class="social">
        <a href="https://github.com/ayush7770/test"><i class="fab fa-github"></i></a>
...
async def homepage(request):
    ...
    return web.Response(text="<h1>See REPO <a href='https://github.com/ayush7770/test'>@GitHub</a> By <a href='https://github.com/ayushteke'>ayushteke</a></h1>", content_type="text/html")
